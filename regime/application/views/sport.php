                  ...
                  <div class="degrad card-body py-0 px-0 px-sm-3">
                    <div class="row align-items-center">
                      ...
                      <div class=" col-5 col-sm-7 col-xl-8 p-0">
                        <h4 class="mb-1 mb-sm-0"> sport  </h4>
            ...
            <div class="col-12 grid-margin"  >
              <div class="card" style="margin-top: 3%; " >
                <div class="card-body" style="background-color: rgb(255, 255, 250);">
                  <h4 class="card-title" style="color: black;">Insertion sport</h4>
                  <div class="table-responsive">
                    <table class="table" style="text-align: center;">
                    <form method="post" action="<?php echo site_url('Sport_controller/insert_sport') ?>">
                        <tbody>
                            <tr>
                                <td>
                                    <div>
                                        <label for="nom">Sport :</label>
                                        <input style="background-color:#e8edf3;border-radius: 10px;color: black;" type="text" class="form-control"  placeholder="Nom du sport" aria-label="Sport" id="nom" name="nom">
                                    </div>
                                </td>
                                <td>
                ...
                <div class="col-12 grid-margin"  >
                  <div class="card"  style="background-color: rgba(250, 253, 255, 0.764);" >
                    <div class="card-body" style="color:black" >
                      <h4 class="card-title" style="color:black">Listes sports</h4>
                          ...
                          <?php foreach ($sports as $sport) { ?>
                            <tr>
                                <td>
                                    ...
                                    <td><a  class="btn btn-info" href="modifier_sport?idSport=<?php echo $sport->id ?>&nom=<?php echo $sport->nom ?>">Modifier</a></td>
                                    <td><a class="btn btn-danger" href="supprimer_sport?idSport=<?php echo $sport->id ?>">Supprimer</a> </td>
                            </tr>
                            <?php } ?>
                          </tbody>
                        </table>
