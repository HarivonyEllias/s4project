      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        ...
        <ul class="nav">
          ...
          <li class="nav-item menu-items" style="margin-top: 15%;">
            <a class="nav-link" href="<?php site_url('LoginR'); ?>">
              <span class="menu-icon">
                <i class="mdi mdi-speedometer"></i>
              </span>
              <span class="menu-title">Rediriger vers login client</span>
            </a>
          </li>
                  ...
                  <div class="degrad card-body py-0 px-0 px-sm-3">
                    <div class="row align-items-center">
                      ...
                      <div class=" col-5 col-sm-7 col-xl-8 p-0">
                        <h4 class="mb-1 mb-sm-0"> Regime  </h4>
                ...
                <div class="col-12 grid-margin"  >
                  <div class="card"  style="background-color: rgba(250, 253, 255, 0.764);" >
                    <div class="card-body" style="color:black" >
                      <h4 class="card-title" style="color:black">Notifications Codes</h4>
                      <div class="table-responsive" style="text-align: center;" >
                        <table class="table">
                          ...
                          <tbody>
                          <?php foreach ($demandecodes as $dmc) { ?>
                            <tr>
                                <td>
                                    ...
                                    <td><?php echo $dmc->idUtilisateur; ?></td>
                                    <td><?php echo $dmc->idcode; ?></td>
                                    <td><a  class="btn btn-info" href="#">Valider</a></td>
                                    <td><a class="btn btn-danger" href="#">Refuser</a> </td>
                            </tr>
                            <?php } ?>
                          </tbody>
                        </table>
        ...
        <div class="row"  style="background-color: rgba(250, 253, 255, 0.897);" >
            <div class="col-12 grid-margin"  >
              <div class="card" style="margin-top: 3%; " >
                <div class="card-body" style="background-color: rgb(255, 255, 250);">
                  <h4 class="card-title" style="color: black;">Insertion regime</h4>
                        ...
                        <tr>
                            <td>
                                <div>
                                    ...
                                    <input style="background-color:#e8edf3;border-radius: 10px;color: black;" placeholder="Entrer un menu" aria-label="Username" aria-describedby="basic-addon1" type="text" class="form-control" id="menu" name="menu">
                                </div>
                            </td>
                            <td>
                                <div>
                                    <label for="description">Description :</label>
                                    <input style="background-color:#e8edf3;border-radius: 10px;color: black;" placeholder="Description" aria-label="Username" aria-describedby="basic-addon1" type="text" class="form-control" id="description" name="description">
                                </div>
                            </td>
                            <td>
                                <div>
                                    <label for="prix">Prix :</label>
                                    <input style="background-color:#e8edf3;border-radius: 10px;color: black;" type="number" class="form-control"  placeholder="Prix" aria-label="Username" aria-describedby="basic-addon1" id="prix" name="prix">
                                </div>
                            </td>
                            <td>
            ...
            <div class="row " style="margin-top: 3%; " >
                <div class="col-12 grid-margin"  >
                  <div class="card"  style="background-color: rgba(250, 253, 255, 0.764);" >
                    <div class="card-body" style="color:black" >
                      <h4 class="card-title" style="color:black">Listes regimes</h4>
                      <div class="table-responsive" style="text-align: center;" >
                        <table class="table">
                          <thead>
                            <tr>
                          ...
                          <?php foreach ($regimes as $regime) { ?>
                            <tr>
                                <td>
                                    ...
                                    <td><?php echo $regime->menu; ?></td>
                                    <td><?php echo $regime->prix; ?></td>
                                    <td><a  class="btn btn-info" href="modifier_regime?idRegime=<?php echo $regime->id ?>&menu=<?php echo $regime->menu ?>&description=<?php echo $regime->description ?>&prix=<?php echo $regime->prix ?>">Modifier</a></td>
                                    <td><a class="btn btn-danger" href="supprimer_regime?idRegime=<?php echo $regime->id ?>">Supprimer</a> </td>
                            </tr>
                            <?php } ?>
                          </tbody>
                        </table>
