                        ...
                        <tr>
                            <td>
                                <div>
                                    ...
                                    <input style="background-color:#e8edf3;border-radius: 10px;color: black;" placeholder="Entrer un objectif" aria-label="Username" aria-describedby="basic-addon1" type="text" class="form-control" id="menu" name="menu">
                                </div>
                            </td>
                            <td>
                                <div>
